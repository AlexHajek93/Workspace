...
<html lang="en" ><head>
  ...
  <body role="document" id="blackbody">
    ...
    <div class="container theme-showcase" role="main" style="background-color: black;">
      <div class="jumbotron">
        <h1 style="text-align: center;">Well Well Well</h1>
        <p>Looks like someone broke something...</p>
        <p>I'm not saying you did it, but you should probably go to the Home screen...</p>
      </div>
    </div>
