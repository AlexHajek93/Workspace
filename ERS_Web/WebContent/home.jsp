  ...
  <body role="document" id="blackbody">
      ...
      <div class="container">
        ...
        <div id="navbar" class="navbar-collapse collapse">
          <ul class="nav navbar-nav">
            <li class="active"><a id="homecolor" href="./home.jsp">Home</a></li>
    ...
    <div class="container theme-showcase" role="main" style="background-color: black;">
      <div class="jumbotron">
        ...
        <p>Welcome to the Expense Reimbursement System (ERS). If you would like to operate on the system click on the 'Reimburse System' button above. To get more help on how the system works click the 'FAQ & About' button above. Lastly, if there still remain question that you might have, or other matters that you would like to discuss, click on 'Contact Information' above.</p>
      </div>
    </div>
