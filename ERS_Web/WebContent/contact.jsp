  ...
  <body role="document" id="blackbody">
      ...
      <div class="container">
        ...
        <div id="navbar" class="navbar-collapse collapse">
          <ul class="nav navbar-nav">
            ...
            <li class="active"><a id="contcolor" href="./contact.jsp">Contact Information</a></li>
          </ul>
        </div>
      </div>
    </nav>
    <div class="container theme-showcase" role="main" style="background-color: black;">
      <div class="jumbotron">
        ...
        <p>General questions can be sent to <a href="mailto:junkemail@gmail.com">junkemail@gmail.com</a>. Important emails can be sent to <a href="mailto:importantjunkemail@gmail.com">importantjunkemail@gmail.com</a></p>
      </div>
    </div>
