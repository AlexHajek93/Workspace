...
public class ServletHelper extends HttpServlet{
	...
	public void nrole(HttpServletRequest req, HttpServletResponse resp) throws IOException{
		if(dao.createRole(new ErsRole(1,req.getParameter("newrole"))))
			resp.sendRedirect("page.jsp"); 
		else
			resp.sendRedirect("state.jsp");
	}
	public void nreim(HttpServletRequest req, HttpServletResponse resp) throws IOException{
		System.out.println("Entered");
		
		System.out.println(Integer.parseInt(req.getParameter("amount")));
		System.out.println(new Date(1));
		System.out.println(new ErsUser((int)req.getSession().getAttribute("userid"), " ", " ", " ", " ", " ", new ErsRole(1, " ")));
		System.out.println(new ErsStatus(1, "Pending") +" "+ new ErsType());
		if(dao.createReim(new ErsReimbursement(1, 20, new Date(1), new ErsUser((int)req.getSession().getAttribute("userid"), " ", " ", " ", " ", " ", new ErsRole(1, " ")), new ErsStatus(1, "Pending"), new ErsType())))
			resp.sendRedirect("page.jsp");
		else
			resp.sendRedirect("page.jsp");
	}
	public void creim(HttpServletRequest req, HttpServletResponse resp) throws IOException{
		//Needs work
		resp.sendRedirect("page.jsp");
	}
